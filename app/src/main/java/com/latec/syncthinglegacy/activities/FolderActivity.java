...
import com.latec.syncthinglegacy.databinding.FragmentFolderBinding;
...
import com.latec.syncthinglegacy.util.FileUtils;
import com.latec.syncthinglegacy.util.TextWatcherAdapter;
import com.latec.syncthinglegacy.util.Util;
...
import static com.latec.syncthinglegacy.service.SyncthingService.State.ACTIVE;
...
public class FolderActivity extends SyncthingActivity
    ...
    public static final String EXTRA_NOTIFICATION_ID =
            "com.latec.syncthinglegacy.activities.FolderActivity.NOTIFICATION_ID";
    public static final String EXTRA_IS_CREATE =
            "com.latec.syncthinglegacy.activities.FolderActivity.IS_CREATE";
    public static final String EXTRA_FOLDER_ID =
            "com.latec.syncthinglegacy.activities.FolderActivity.FOLDER_ID";
    public static final String EXTRA_FOLDER_LABEL =
            "com.latec.syncthinglegacy.activities.FolderActivity.FOLDER_LABEL";
    public static final String EXTRA_DEVICE_ID =
            "com.latec.syncthinglegacy.activities.FolderActivity.DEVICE_ID";
    ...
    private void checkWriteAndUpdateUI() {
        ...
        if (mCanWriteToPath) {
            ...
            if (mIsCreateMode) {
                 ...
                 * "[storage]/Android/data/com.latec.syncthinglegacy/files"
