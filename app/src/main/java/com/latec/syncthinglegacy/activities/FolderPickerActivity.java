...
public class FolderPickerActivity extends SyncthingActivity
    ...
    private static final String EXTRA_INITIAL_DIRECTORY =
            "com.latec.syncthinglegacy.activities.FolderPickerActivity.INITIAL_DIRECTORY";

    private static final String EXTRA_ROOT_DIRECTORY =
            "com.latec.syncthinglegacy.activities.FolderPickerActivity.ROOT_DIRECTORY";

    public static final String EXTRA_RESULT_DIRECTORY =
            "com.latec.syncthinglegacy.activities.FolderPickerActivity.RESULT_DIRECTORY";
