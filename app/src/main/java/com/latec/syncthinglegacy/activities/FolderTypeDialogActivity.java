...
public class FolderTypeDialogActivity extends ThemedAppCompatActivity {
    ...
    public static final String EXTRA_FOLDER_TYPE = "com.latec.syncthinglegacy.activities.FolderTypeDialogActivity.FOLDER_TYPE";
    public static final String EXTRA_RESULT_FOLDER_TYPE = "com.latec.syncthinglegacy.activities.FolderTypeDialogActivity.EXTRA_RESULT_FOLDER_TYPE";
